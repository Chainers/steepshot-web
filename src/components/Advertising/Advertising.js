				...
				<div className="wrapper_advertising centered--flex">
					<div className="sub-wrapper_advertising">
						<div className="text-wrapper_advertising">
							<p>Participate in our new contest. Make a post dealing with the topic of 2018 FIFA World Cup tagged both&nbsp;
								...
								<a href="https://steemit.com/steem/@steepshot/steepshot-is-pleased-to-announce-a-new-photo-contest-dedicated-to-2018-fifa-world-cup-russia"
									 target="_blank"
