  ...
  if (error.data || error.payload) {
    ...
    let errorsList = [
      {error: ['4100000 plugin_exception: plugin exception: Account: ${account} bandwidth limit exeeded. Please wait to ' + // eslint-disable-line
        ...
        'exceeded. Please wait to transact or power up steem.'],
        notificationText: 'Your transaction cannot be completed. Steem Power of your account is too low. For more ' +
        'information click <a href="https://steepshot.io/faq#not-able-to-post" target="_blank">here</a>.'},
      {error: ['10 assert_exception: Assert Exception: elapsed_seconds >= STEEM_MIN_VOTE_INTERVAL_SEC: Can only vote ' +
        'once every 3 seconds.', '10 assert_exception: Assert Exception: elapsed_seconds >= STEEMIT_MIN_VOTE_INTERVAL_SEC:' +
      ...
      {error: ['10 assert_exception: Assert Exception: abs_rshares > STEEM_VOTE_DUST_THRESHOLD || o.weight == 0: ' +
        'Voting weight is too small, please accumulate more voting power or steem power.', '10 assert_exception: Assert ' +
        'Exception: abs_rshares > 30000000 || o.weight == 0: Voting weight is too small, please accumulate more voting ' +
        'power or steem power.', '10 assert_exception: Assert Exception: info->abs_rshares > STEEM_VOTE_DUST_THRESHOLD || ' +
        'vote_weight == 0: Voting weight is too small, please accumulate more voting power or steem power.'],
        notificationText: 'You cannot vote this way because you haven’t got enough Steem Power. For more information ' +
        'click <a href="https://steepshot.io/faq#not-able-to-post" target="_blank">here</a>.'},
      ...
      {error: '3010000 tx_missing_active_auth: missing required active authority: Missing Active Authority ${id}',
